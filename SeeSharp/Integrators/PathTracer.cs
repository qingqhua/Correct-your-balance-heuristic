...
public class PathTracerBase<PayloadType> : Integrator {
    ...
    protected ref struct PathState {
        ...
        public float[] pss { get; set; }
        public RgbColor PreviousBsdfCos { get; set; }
        public RgbColor PreviousThroughput { get; set; }
        public float[] PreviousGuidePdfs { get; set; }
        public float PreviousBsdfPdf { get; set; }
        public float PreviousSelectProb { get; set; }
        public float[] NeePrimarySamples { get; set; }
    }
